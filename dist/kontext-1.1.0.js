...
/*
 *       __    Kontext (version 1.1.0 - 2015-12-26)
 *      /\_\
...
;(function(global) {
	 ...
	 *  BUILD INFO
	 *  ---------------------------------------------------------------------
	 *    date: Sat Dec 26 2015 00:57:40 GMT+0100 (CET)
	 *    time: 4.47ms
	 *    size: 38.65KB
	 */
	...
	//END INCLUDE: lib/settings [736.52µs, 1.81KB]
	...
	//END INCLUDE: lib/emission [284.07µs, 2.87KB]
	...
	//END INCLUDE: lib/observer [230.77µs, 1.98KB]
	...
	//END INCLUDE: lib/text [360.22µs, 2.23KB]
	...
	function /*jshint unused: false*/Attribute()/*jshint unused: true*/ {
		...
		//END INCLUDE: json-formatter [358.28µs, 6.41KB]
		/**
		 *  Initializer - setting up the defaults
		 *  @name    init
		 *  @access  internal
	...
	//END INCLUDE: lib/attribute [910.81µs, 8.32KB]
	function Kontext() {
		var kontext = this,
