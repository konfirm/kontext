...
;(function(global) {
	 ...
	 *  BUILD INFO
	 *  ---------------------------------------------------------------------
	 *    date: Sat Dec 19 2015 17:04:24 GMT+0100 (CET)
	 *    time: 2.95ms
	 *    size: 36.76KB
	 */
	...
	//END INCLUDE: lib/settings [486.93µs, 1.81KB]
	...
	//END INCLUDE: lib/emission [141.82µs, 2.87KB]
	...
	//END INCLUDE: lib/observer [143.59µs, 1.98KB]
	...
	//END INCLUDE: lib/text [114.01µs, 2.23KB]
	...
	function /*jshint unused: false*/Attribute()/*jshint unused: true*/ {
		...
		//END INCLUDE: json-formatter [186.57µs, 6.41KB]
		/**
		 *  Initializer - setting up the defaults
		 *  @name    init
		 *  @access  internal
	...
	//END INCLUDE: lib/attribute [498.64µs, 8.32KB]
	function Kontext() {
		var kontext = this,
