...
/*
 *       __    Kontext (version 1.3.0 - 2015-12-28)
 *      /\_\
...
;(function(global) {
	 ...
	 *  BUILD INFO
	 *  ---------------------------------------------------------------------
	 *    date: Mon Dec 28 2015 15:01:39 GMT+0100 (CET)
	 *    time: 3.17ms
	 *    size: 39.03KB
	 */
	...
	//END INCLUDE: lib/settings [596.36µs, 1.81KB]
	...
	//END INCLUDE: lib/emission [152.28µs, 2.87KB]
	...
	//END INCLUDE: lib/observer [99.21µs, 1.98KB]
	...
	//END INCLUDE: lib/text [133.67µs, 2.23KB]
	...
	function /*jshint unused: false*/Attribute()/*jshint unused: true*/ {
		...
		//END INCLUDE: json-formatter [193.43µs, 6.41KB]
		/**
		 *  Initializer - setting up the defaults
		 *  @name    init
		 *  @access  internal
	...
	//END INCLUDE: lib/attribute [549.48µs, 8.32KB]
	function Kontext() {
		var kontext = this,
