...
/*
 *       __    Kontext (version 2.0.0-rc1 - 2017-03-15)
 *      /\_\
...
;(function(global) {
	 ...
	 *  BUILD INFO
	 *  ---------------------------------------------------------------------
	 *    date: Wed Mar 15 2017 10:38:10 GMT+0100 (CET)
	 *    time: 4.53ms
	 *    size: 33.34KB
	 *  ---------------------------------------------------------------------
	 *   included 3 files
	...
	//END INCLUDE: lib/settings [1.32ms, 3.72KB]
	...
	//END INCLUDE: lib/emission [617.11µs, 2.88KB]
	...
	//END INCLUDE: lib/observer [513.73µs, 1.99KB]
	/**
	 *  Kontext module
	 *  @name     Kontext
	 *  @package  Kontext
...
(function(kontext) {
	...
	//END INCLUDE: ../lib/condition [628.85µs, 11.57KB]
...
(function(kontext) {
	...
	//END INCLUDE: ../lib/template [659.65µs, 5.12KB]
...
(function(kontext) {
	...
	function Attribute() {  //  eslint-disable-line no-unused-vars
		...
		//END INCLUDE: tokenizer [571.03µs, 4.98KB]
		/**
		 *  JSON Formatter
		 *  @name     JSONFormatter
		 *  @package  Kontext
		...
		//END INCLUDE: json-formatter [1.39ms, 10.01KB]
		/**
	...
	//END INCLUDE: ../lib/attribute [2.17ms, 12.69KB]
...
(function(kontext) {
	...
	//END INCLUDE: ../lib/text [418.01µs, 2.66KB]
