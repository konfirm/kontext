...
/*
 *       __    Kontext (version 1.3.1 - 2015-12-29)
 *      /\_\
...
;(function(global) {
	 ...
	 *  BUILD INFO
	 *  ---------------------------------------------------------------------
	 *    date: Tue Dec 29 2015 01:23:32 GMT+0100 (CET)
	 *    time: 6.89ms
	 *    size: 39.08KB
	 */
	...
	//END INCLUDE: lib/settings [522.84µs, 1.81KB]
	...
	//END INCLUDE: lib/emission [3.70ms, 2.87KB]
	...
	//END INCLUDE: lib/observer [123.93µs, 1.98KB]
	...
	//END INCLUDE: lib/text [161.12µs, 2.23KB]
	...
	function /*jshint unused: false*/Attribute()/*jshint unused: true*/ {
		...
		//END INCLUDE: json-formatter [229.91µs, 6.41KB]
		/**
		 *  Initializer - setting up the defaults
		 *  @name    init
		 *  @access  internal
	...
	//END INCLUDE: lib/attribute [613.10µs, 8.32KB]
	function Kontext() {
		var kontext = this,
