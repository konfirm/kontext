...
/*
 *       __    Kontext (version 1.3.2 - 2015-12-29)
 *      /\_\
...
;(function(global) {
	 ...
	 *  BUILD INFO
	 *  ---------------------------------------------------------------------
	 *    date: Tue Dec 29 2015 12:04:36 GMT+0100 (CET)
	 *    time: 3.03ms
	 *    size: 39.12KB
	 */
	...
	//END INCLUDE: lib/settings [499.83µs, 1.81KB]
	...
	//END INCLUDE: lib/emission [154.52µs, 2.87KB]
	...
	//END INCLUDE: lib/observer [103.89µs, 1.98KB]
	...
	//END INCLUDE: lib/text [132.81µs, 2.23KB]
	...
	function /*jshint unused: false*/Attribute()/*jshint unused: true*/ {
		...
		//END INCLUDE: json-formatter [190.50µs, 6.41KB]
		/**
		 *  Initializer - setting up the defaults
		 *  @name    init
		 *  @access  internal
	...
	//END INCLUDE: lib/attribute [536.93µs, 8.32KB]
	function Kontext() {
		var kontext = this,
