...
/*
 *       __    Kontext (version 1.2.0 - 2015-12-26)
 *      /\_\
...
;(function(global) {
	 ...
	 *  BUILD INFO
	 *  ---------------------------------------------------------------------
	 *    date: Sat Dec 26 2015 12:22:56 GMT+0100 (CET)
	 *    time: 6.79ms
	 *    size: 39.03KB
	 */
	...
	//END INCLUDE: lib/settings [551.62µs, 1.81KB]
	...
	//END INCLUDE: lib/emission [3.62ms, 2.87KB]
	...
	//END INCLUDE: lib/observer [136.86µs, 1.98KB]
	...
	//END INCLUDE: lib/text [166.87µs, 2.23KB]
	...
	function /*jshint unused: false*/Attribute()/*jshint unused: true*/ {
		...
		//END INCLUDE: json-formatter [236.97µs, 6.41KB]
		/**
		 *  Initializer - setting up the defaults
		 *  @name    init
		 *  @access  internal
	...
	//END INCLUDE: lib/attribute [559.10µs, 8.32KB]
	function Kontext() {
		var kontext = this,
